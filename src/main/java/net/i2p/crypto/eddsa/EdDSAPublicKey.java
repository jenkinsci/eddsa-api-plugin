...
public class EdDSAPublicKey implements EdDSAKey, PublicKey {
    ...
    public byte[] getEncoded() {
        if (!edDsaSpec.equals(EdDSANamedCurveTable.ED_25519_CURVE_SPEC)) return null;
    ...
    public GroupElement getNegativeA() {
        // Only read Aneg once, otherwise read re-ordering might occur between here and return. Requires all
        // GroupElement's fields to be final.
