...
public class EdDSAPublicKeyTest {
    ...
    public void testDecodeAndEncode() throws Exception {
        ...
        // Encode
        EdDSAPublicKeySpec decoded = new EdDSAPublicKeySpec(keyIn.getA(), keyIn.getParams());
